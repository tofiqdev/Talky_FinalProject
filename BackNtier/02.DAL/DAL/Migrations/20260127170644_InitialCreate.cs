        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CallType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "voice"),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, defaultValue: "ringing"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMutedForAll = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    Deleted = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Group_UpdatedAt", "[UpdatedAt] >= [CreatedAt]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GroupMember_JoinedAt", "[JoinedAt] <= GETUTCDATE()");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_GroupMessage_Content", "LEN([Content]) > 0");
                    table.CheckConstraint("CK_GroupMessage_SentAt", "[SentAt] <= GETUTCDATE()");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "idx_Receiver_Started",
                table: "Calls",
                columns: new[] { "ReceiverId", "StartedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "idx_GroupMember_Group_IsAdmin",
                table: "GroupMembers",
                columns: new[] { "GroupId", "IsAdmin" });

            migrationBuilder.CreateIndex(
                name: "idx_GroupMember_Group_User_Deleted",
                table: "GroupMembers",
                columns: new[] { "GroupId", "UserId", "Deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_GroupMember_GroupId",
                table: "GroupMembers",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "idx_GroupMember_UserId",
                table: "GroupMembers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "idx_GroupMessage_Group_Deleted_SentAt",
                table: "GroupMessages",
                columns: new[] { "GroupId", "Deleted", "SentAt" });

            migrationBuilder.CreateIndex(
                name: "idx_GroupMessage_Group_IsSystem",
                table: "GroupMessages",
                columns: new[] { "GroupId", "IsSystemMessage" });

            migrationBuilder.CreateIndex(
                name: "idx_GroupMessage_Group_SentAt",
                table: "GroupMessages",
                columns: new[] { "GroupId", "SentAt" });

            migrationBuilder.CreateIndex(
                name: "idx_GroupMessage_SenderId",
                table: "GroupMessages",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "idx_Group_CreatedAt",
                table: "Groups",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "idx_Group_CreatedById",
                table: "Groups",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "idx_Group_Name_Deleted",
                table: "Groups",
                columns: new[] { "Name", "Deleted" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_Group_UpdatedAt",
                table: "Groups",
                column: "UpdatedAt");
